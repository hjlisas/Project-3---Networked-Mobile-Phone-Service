...
public class HistoryDialog extends Dialog {
    ...
    public HistoryDialog( theClient parent, boolean modal) {
        super(parent, modal);
        c = parent;
        initComponents();
        this.setSize( 535, 280);
    ...
    private void initComponents() {
        ...
        add(label1, new AbsoluteConstraints(160, 30, -1, -1));
        
        label2.setText("POSTPAID SUBSCRIBER");
        add(label2, new AbsoluteConstraints(80, 90, 150, -1));
        
        label3.setText("COMMAND STRING");
        add(label3, new AbsoluteConstraints(50, 150, -1, -1));
        
        commandString.setFont(new Font("Dialog", 1, 14));
        add(commandString, new AbsoluteConstraints(50, 180, 430, -1));
        ...
        add(okButton, new AbsoluteConstraints(230, 220, 100, -1));
        ...
        add(postpaidSubscribers, new AbsoluteConstraints(270, 90, 250, -1));
    ...
    private void postpaidSubscribersItemStateChanged(ItemEvent evt) 
    {
    	try
    	{
    		commandString.setText( "history " + extractNumber( ( String ) evt.getItem() ) );
    	}
    	catch( Exception e ) {}
    }
    ...
    public static void main(String args[]) {
        new HistoryDialog(new theClient(), true).show();
    }
